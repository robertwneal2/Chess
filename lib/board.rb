...
class Board 
  ...
  def generate_board
    ...
    board_arr[7][0] = Bishop.new(:black, self, [0, 0]) # Black non-pawn pieces
    board_arr[7][1] = Knight.new(:black, self, [0, 1])
    board_arr[7][2] = Rook.new(:black, self, [0, 2])
    board_arr[7][3] = Queen.new(:black, self, [0, 3])
    board_arr[7][4] = King.new(:black, self, [0, 4])
    board_arr[7][5] = Rook.new(:black, self, [0, 5])
    board_arr[7][6] = Knight.new(:black, self, [0, 6])
    board_arr[7][7] = Bishop.new(:black, self, [0, 7])
